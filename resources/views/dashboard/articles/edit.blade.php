          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title"
                placeholder="Masukkan judul artikel" value="{{ old('title', $article->title) }}" autofocus>
              @error('title')
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug"
                placeholder="Masukkan slug artikel" value="{{ old('slug', $article->slug) }}" readonly>
              @error('slug')
                <div class=" invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="form-group">
              ...
              @if ($article->image)
                <img src="{{ asset('storage/' . $article->image) }}" class="img-fluid img-preview d-block">
              @else
