  ...
  <div class="container page-articles mb-4">
    <div class="mb-3">
      <a href="/" class="links-header">Beranda</a>&nbsp;&nbsp;>&nbsp;&nbsp;<span
        class="links-header mute">Service</span>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="/services/langkah-awal"
        class="links-header active">Langkah Awal</a>
    </div>
    <div class="border-bottom w-100 m-auto mt-3"></div>
    <div class="row mt-4 d-flex justify-content-center">
      <div class="col-12 col-md-8 mb-4">
        <figure class="mt-4">
          <h4 class="fw-bold">Mulai langkah awal anda untuk berkebun</h4>
          <blockquote class="blockquote">
            <p>Tahapan untuk paham dan mengerti dasar - dasar perkebunan</p>
          </blockquote>
      ...
      <div class="col-12 col-md-4">
        ...
        @foreach ($services->whereNotIn('slug', ['langkah-awal']) as $service)
